...
namespace cetech {
    ...
    namespace queue_internal {
        ...
        template < typename T > void increase_capacity(Queue < T >& q,
            ...
            if (q._offset + q._size > end) {
                ...
                memmove(array::begin(q._data) + new_capacity - end_items, array::begin(
                            q._data) + q._offset, end_items * sizeof(T));
                q._offset += new_capacity - end;
            }
        }

        template < typename T > void grow(Queue < T >& q,
    ...
    ***************************************************************************/
    namespace queue {
        ...
        template < typename T > inline void push_back(Queue < T >& q,
                                                      const T& item) {
            if (!space(q)) {
        ...
        template < typename T > inline void push_front(Queue < T >& q,
                                                       const T& item) {
            if (!space(q)) {
                queue_internal::grow(q);
            }
        ...
        template < typename T > inline void consume(Queue < T >& q,
                                                    const uint32_t n) {
