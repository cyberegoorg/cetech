...
namespace System.Yaml.Serialization
{
    /// <summary>
    ///     <para>
    ///         <see cref="YamlSerializer" /> class has instance methods <see cref="Serialize(object)" /> and
    ///         <see cref="Deserialize(string,Type[])" />,
    ...
    ///     <para>
    ///         <see cref="YamlSerializer" /> can serialize / deserialize native C# objects of primitive types
    ...
    ///     </para>
    ///     <para>
    ///         A YAML document generated by <see cref="YamlSerializer" /> always have a %YAML directive and
    ...
    ///         <see cref="YamlSerializeMethod.Content">
    ...
    ///         Such a deserializing method is refered to
    ///         <see cref="YamlSerializeMethod.Assign">
    ///             YamlSerializeMethod.Assign
    ///         </see>
    ///         . Writeable properties can be explicitly specified to use
    ...
    ///         <see cref="YamlSerializeMethod.Binary">
    ...
    ///     </para>
    ///     <para>
    ///         If serializing method <see cref="YamlSerializeMethod.Never" /> is specified,
    ...
    ///     <para>
    ///         <see cref="YamlSerializer" /> is aware of
    ...
    ///     </para>
    ///     <para>
    ///         It also checkes for the result of ShouldSerializeXXX method. For instance, just before serializing <c>Font</c>
    ///         property of some type, <c>bool ShouldSerializeFont()</c> method is called if exists. If the method returns
    ///         false,
    ///         <c>Font</c> property will not be written in the YAML text. ShouldSerializeXXX method can be non-public.
    ///     </para>
    ///     <code>
    ...
    ///     <para>
    ///         If an object implements <see cref="ICollection{T}" />, <see cref="IList" /> or <see cref="IDictionary" />
    ///         the child objects are serialized as well its other public members.
    ///         Pseudproperty <c>ICollection.Items</c> or <c>IDictionary.Entries</c> appears to hold the child objects.
    ///     </para>
    ///     <h3>Multitime appearance of a same object</h3>
    ///     <para>
    ///         <see cref="YamlSerializer" /> preserve C# objects' graph structure. Namely, when a same objects are refered to
    ...
    ///  </code>
    ///     <para>
    ///         This is not the case if the object is <see cref="string" />. Same instances of
    ...
    ///     <para>
    ///         When serializing, <see cref="YamlSerializer" /> intelligently uses various YAML 1.2 styles,
    ...
    ///  </code>
    ///     <para>
    ///         When deserializing, <see cref="YamlSerializer" /> accepts any valid YAML 1.2 documents.
    ...
    ///     </para>
    ///     <para>
    ///         By default, <see cref="YamlSerializer" /> outputs a YAML stream with line break of "\r\n".
    ///         This can be customized either by setting <c>YamlNode.DefaultConfig.LineBreakForOutput</c> or
    ///         by giving an instance of <see cref="YamlConfig" /> to the
    ///         <see cref="YamlSerializer(YamlConfig)">
    ///             constructor
    ///         </see>
    ///         .
    ///     </para>
    ...
    ///         <see cref="YamlConfig.ExplicitlyPreserveLineBreaks">
    ...
    ///     </para>
    ///     <para>
    ///         One is to set <see cref="YamlConfig.LineBreakForInput">YamlConfig.LineBreakForInput</see>
    ///         to be "\r\n". Then, the YAML parser normalizes all line breaks into "\r\n" instead of "\n".
    ///     </para>
    ///     <para>
    ///         The other is to set <see cref="YamlConfig.NormalizeLineBreaks">YamlConfig.NormalizeLineBreaks</see>
    ...
    {
        private static readonly YamlRepresenter representer = new YamlRepresenter();
        private static readonly YamlConstructor constructor = new YamlConstructor();
        ...
        /// <summary>
        ///     Serialize C# object <paramref name="obj" /> into YAML text and write it into a <see cref="Stream" />
        ///     <paramref name="s" />.
        /// </summary>
        ...
        /// <summary>
        ///     Serialize C# object <paramref name="obj" /> into YAML text and write it into a <see cref="TextWriter" />
        ///     <paramref name="tw" />.
        /// </summary>
        ...
        /// <summary>
        ///     Serialize C# object <paramref name="obj" /> into YAML text and save it into a file named as
        ///     <paramref name="YamlFileName" />.
        /// </summary>
