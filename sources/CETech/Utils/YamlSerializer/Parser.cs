...
namespace System.Yaml
{
        ...
        where State : struct
    {
        ...
        ///         To show or log the warning, override <see cref="StoreWarning" />.
        ///     </para>
        /// </summary>
        /// <example>
        ///     <code>
        ...
        /// <remarks>
        ///     <para>
        ///         This recoveres <see cref="p" />, <see cref="stringValue" />, <see cref="state" />
        ///         when <paramref name="condition" /> does not return <code>true</code>.
        ///     </para>
        ///     <para>
        ///         If any specific operation is needed for rewinding, in addition to simply
        ///         recover the value of <see cref="state" />, override <see cref="Rewind()" />.
        ///     </para>
        /// </remarks>
        ...
        ///     <para>
        ///         Note: Do not forget <see cref="RewindUnless" /> if several
        ///         rules are sequentially appears in <see cref="Repeat(Func&lt;bool&gt;)" /> operator.
        ///     </para>
        ///     <code>
        ///  bool LinesOrEmpty()
        ///  {
        ...
        ///     <para>
        ///         Note: Do not forget <see cref="RewindUnless" /> if several
        ///         rules are sequentially appears in <see cref="Repeat(int,Func&lt;bool&gt;)" /> operator.
        ///     </para>
        ///     <code>
        ///  bool FourLines()
        ///  {
        ...
        ///     <para>
        ///         Note: Do not forget <see cref="RewindUnless" /> if several
        ///         rules are sequentially appears in <see cref="Repeat(int,int,Func&lt;bool&gt;)" /> operator.
        ///     </para>
        ///     <code>
        /// bool Google()
        /// {
        ...
        ///     <para>
        ///         Note: Do not forget <see cref="RewindUnless" /> if several
        ///         rules are sequentially appears in <see cref="Optional(bool)" /> operator.
        ///     </para>
        ///     <code>
        /// bool File()
        /// {
        ...
        ///     <para>
        ///         Note: Do not forget <see cref="RewindUnless" /> if several
        ///         rules are sequentially appears in <see cref="Optional(Func&lt;bool&gt;)" /> operator.
        ///     </para>
        ///     <code>
        /// bool File()
        /// {
        ...
        ///     </para>
        ///     <para>
        ///         Use <see cref="Charset(System.Int32, System.Func&lt;char, bool&gt;)" /> form to explicitly
        ...
        /// <param name="value">
        ///     If the <paramref name="rule" /> matches,
        ...
        /// <summary>
        ///     <para>
        ///         Saves a part of the source text that is reduced in the <paramref name="rule" />
        ///         and append it to <see cref="stringValue" />.
        ///     </para>
        ///     <para>If the rule does not match, nothing happends.</para>
        /// </summary>
        /// <param name="rule">Reduction rule to match.</param>
        ...
        /// <param name="rule">Reduction rule to match.</param>
        /// <param name="save">
        ///     If <paramref name="rule" /> matches, this delegate is invoked
        ...
        protected bool ErrorUnlessWithAdditionalCondition(Func<bool> rule, bool to_be_error, string message,
            params object[] args)
        {
            if (to_be_error)
            {
