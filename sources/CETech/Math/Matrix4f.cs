...
namespace CETech.World
{
    public struct Matrix4f
    {
        ...
        public static Matrix4f CreateBillboard (Vector3f objectPosition, Vector3f cameraPosition, Vector3f cameraUpVector, Vector3f cameraForwardVector) {
