...
SCENARIO( "Malloc/Free", "[memory]" ) {
    GIVEN( "8B memory" ) {
        char* test_memory = (char*) memory_malloc(_8B);
...
SCENARIO( "Memory copy", "[memory]" ) {
    GIVEN( "2 x 8B memory" ) {
        char* src_memory = (char*) memory_malloc(_8B);
        char* dst_memory = (char*) memory_malloc(_8B);
