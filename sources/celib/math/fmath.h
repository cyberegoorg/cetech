...
CE_FORCE_INLINE float f_floor(float f) {
    return floorf(f);
}

CE_FORCE_INLINE float f_ceil(float f) {
    return ceilf(f);
}

CE_FORCE_INLINE float f_round(float f) {
    return f_floor(f + 0.5f);
}

CE_FORCE_INLINE float f_min(float a, float b) {
    return a < b ? a : b;
}

CE_FORCE_INLINE float f_min3(float a, float b, float c) {
    return f_min(a, f_min(b, c));
}

CE_FORCE_INLINE float f_max(float a, float b) {
    return a > b ? a : b;
}

CE_FORCE_INLINE float f_max3(float a, float b, float c) {
    return f_max(a, f_max(b, c));
}

CE_FORCE_INLINE float f_abs(float a) {
    return a < 0.0f ? -a : a;
}
...
CE_FORCE_INLINE bool f_equal(float a, float b, float epsilon) {
...
CE_FORCE_INLINE bool f_equals(const float *__restrict _a,
...
CE_FORCE_INLINE float f_bias(float time, float bias) {
    /// http://blog.demofox.org/2012/09/24/bias-and-gain-are-your-friend/
    return time / ((1.0f / bias - 2.0f) * (1.0f - time) + 1.0f);
}


CE_FORCE_INLINE float f_gain(float time, float gain) {
    /// http://blog.demofox.org/2012/09/24/bias-and-gain-are-your-friend/
    if (time < 0.5f)
...
CE_FORCE_INLINE float f_to_rad(float angle) {
    return angle * f_ToRad;
}

CE_FORCE_INLINE float f_to_deg(float angle) {
    return angle * f_ToDeg;
}

CE_FORCE_INLINE float f_sin(float angle) {
    return sinf(angle);
}

CE_FORCE_INLINE float f_cos(float angle) {
    return cosf(angle);
}

CE_FORCE_INLINE float f_fast_inv_sqrt(float number) {
...
CE_FORCE_INLINE float f_fast_sqrt(float number) {
    return f_fast_inv_sqrt(number) * number;
}

CE_FORCE_INLINE float f_sqrt(float number) {
    return sqrtf(number);
}

CE_FORCE_INLINE float f_sq(float f) {
    return f * f;
}

CE_FORCE_INLINE float f_atan2(float y, float x) {
    return atan2f(y, x);
}

CE_FORCE_INLINE float f_asin(float f) {
    if (-1.0f < f) {
        if (f < 1.0f)
            return asinf(f);
...
CE_FORCE_INLINE float f_acos(float f) {
    if (-1.0f < f) {
        if (f < 1.0f)
            return acosf(f);
