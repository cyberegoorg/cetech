...
static CE_FORCE_INLINE void quatf_move(float *__restrict result, const float *__restrict a) {
    result[0] = a[0];
    result[1] = a[1];
    result[2] = a[2];
    result[3] = a[3];
...
static CE_FORCE_INLINE bool quatf_eq(const float* __restrict a, const float* __restrict b, const float epsilon) {
    return f_equals(a, b, 4, epsilon);
}


static CE_FORCE_INLINE void quatf_from_axis_angle(float *__restrict result, const float *__restrict axis,
                                                  const float angle) {
    vec3f_t norm_axis;
...
static CE_FORCE_INLINE void quatf_from_euler(float *__restrict result, float heading, float attitude, float bank) {
...
static CE_FORCE_INLINE void quatf_to_mat44f(float *__restrict result, const float *__restrict a) {
...
static CE_FORCE_INLINE void quatf_to_eurel_angle(float *__restrict result,const float *__restrict a) {
...
static CE_FORCE_INLINE void quatf_add(float *__restrict result,
...
static CE_FORCE_INLINE void quatf_sub(float *__restrict result, const float *__restrict a,
                                      const float *__restrict b) {
    result[0] = a[0] - b[0];
    result[1] = a[1] - b[1];
    result[2] = a[2] - b[2];
...
static CE_FORCE_INLINE void quatf_neg(float *__restrict result, const float *__restrict a) {
    result[0] = -a[0];
    result[1] = -a[1];
    result[2] = -a[2];
    result[3] = -a[3];
...
static CE_FORCE_INLINE void quatf_mul_s(float *__restrict result, const float *__restrict a, const float s) {
    result[0] = a[0] * s;
    result[1] = a[1] * s;
    result[2] = a[2] * s;
    result[3] = a[3] * s;
...
static CE_FORCE_INLINE void quatf_div_s(float *__restrict result, const float *__restrict a, const float s) {
    result[0] = a[0] / s;
    result[1] = a[1] / s;
    result[2] = a[2] / s;
    result[3] = a[3] / s;
...
static CE_FORCE_INLINE void quatf_mul(float *__restrict result, const float *__restrict a,
                                      const float *__restrict b) {
...
static CE_FORCE_INLINE void quatf_mul_vec3f(float *__restrict result, const float *__restrict a,
                                            const float *__restrict b) {
...
static CE_FORCE_INLINE float quatf_length_squared(const float *__restrict a) {
    return (a[0] * a[0]) + (a[1] * a[1]) + (a[2] * a[2]) + (a[3] * a[3]);
}

static CE_FORCE_INLINE float quatf_length(const float *__restrict a) {
    return f_fast_sqrt(quatf_length_squared(a));
}

static CE_FORCE_INLINE float quatf_inv_length(const float *__restrict a) {
    return f_fast_inv_sqrt(quatf_length_squared(a));
}

static CE_FORCE_INLINE void quatf_normalized(float *__restrict result, const float *__restrict a) {
    quatf_mul_s(result, a, quatf_inv_length(a));
}

static CE_FORCE_INLINE void quatf_invert(float *__restrict result, const float *__restrict a) {
    result[0] = -a[0];
    result[1] = -a[1];
    result[2] = -a[2];
    result[3] = a[3];
