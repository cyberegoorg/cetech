...
CEL_FORCE_INLINE f32 vec3f_dot(const vec3f_t *__restrict a,
                              const vec3f_t *__restrict b) {
...
CEL_FORCE_INLINE f32 vec3f_length_squared(const vec3f_t *__restrict a) {
    return (a->f[0] * a->f[0]) + (a->f[1] * a->f[1]) + (a->f[2] * a->f[2]);
}

CEL_FORCE_INLINE f32 vec3f_length(const vec3f_t *__restrict a) {
