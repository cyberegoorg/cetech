...
namespace cetech {
    namespace simd {
        CE_INLINE SimdVector make_simd_vector(const float x,
                                              const float y,
                                              const float z,
                                              const float w) {
        ...
        CE_INLINE float get_element(const SimdVector& v1,
                                    const uint32_t idx) {
            return v1.v[idx];
        }

        CE_INLINE SimdVector add(const SimdVector& v1,
                                 const SimdVector& v2) {
            SimdVector ret;
        ...
        CE_INLINE SimdVector sub(const SimdVector& v1,
                                 const SimdVector& v2) {
            SimdVector ret;
        ...
        CE_INLINE SimdVector mul(const SimdVector& v1,
                                 const SimdVector& v2) {
            SimdVector ret;
        ...
        CE_INLINE SimdVector div(const SimdVector& v1,
                                 const SimdVector& v2) {
            SimdVector ret;
