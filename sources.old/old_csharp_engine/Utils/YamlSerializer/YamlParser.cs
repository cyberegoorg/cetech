...
namespace System.Yaml
{
    ...
    {
        private readonly AnchorDictionary Anchors;

        private YamlConfig config;
        private readonly List<YamlNode> ParseResult = new List<YamlNode>();

        private readonly YamlTagPrefixes TagPrefixes;
        private readonly YamlTagValidator TagValidator = new YamlTagValidator();
        ...
        private readonly Dictionary<string, bool> WarningAdded = new Dictionary<string, bool>();
        ...
        private readonly Dictionary<char, bool> AlreadyWarnedChars = new Dictionary<char, bool>();
        ...
        private class Charsets
        {
            ...
            ///     [22]
            /// </summary>
            public static readonly Func<char, bool> cIndicator;

            /// <summary>
            ///     [23]
            /// </summary>
            public static readonly Func<char, bool> cFlowIndicator;

            public static readonly Func<char, bool> nsDecDigit;
            public static readonly Func<char, bool> nsHexDigit;
            public static readonly Func<char, bool> nsAsciiLetter;
            public static readonly Func<char, bool> nsWordChar;
            public static readonly Func<char, bool> sSpace;
            public static readonly Func<char, bool> sWhite;
            public static readonly Func<char, bool> nbChar;
            public static readonly Func<char, bool> nbCharWithWarning;
            public static readonly Func<char, bool> nsChar;
            public static readonly Func<char, bool> nsUriCharSub;
            public static readonly Func<char, bool> nsTagCharSub;
            public static readonly Func<char, bool> nsAnchorChar;
            public static readonly Func<char, bool> nsPlainSafeIn;
            public static readonly Func<char, bool> nsPlainSafeOut;
            public static readonly Func<char, bool> nsPlainFirstSub;
            ...
            public static bool bChar(char c)
            {
                return c == '\n' || c == '\r';
            }
        }

        private bool nbChar() // [27] 
        {
        ...
        private bool bNonContent() // [30] 
        {
            return bBreak();
        }

        private bool sWhite() // [33] 
        {
            if (text[p] == ' ' || text[p] == '\t')
            {
                p++;
        ...
        private bool Repeat_sWhiteAsString()
        {
            var start = p;
        ...
        private bool c_nsEscChar() // [62] 
        {
            ...
            switch (text[p + 1])
            {
                ...
                case 'U':
                    if (
                        !(HexValue(p + 2, out v1) && HexValue(p + 4, out v2) && HexValue(p + 6, out v3) &&
                          HexValue(p + 8, out v4)))
        ...
        private void InvalidEscapeSequence(int n)
        {
        ...
        private bool HexValue(int p, out int v)
        {
            v = 0;
        ...
        private bool TabCharFoundForIndentation;

        private bool sIndent(int n) // [63] 
        {
        ...
        private bool sIndentLT(int n) // [64] 
        {
            Debug.Assert(StartOfLine() || EndOfFile());
            var i = 0;
        ...
        private bool sIndentLE(int n) // [65] 
        {
            return sIndentLT(n + 1);
        }

        private bool sIndentCounted(int n, out int m) // [185, 187]
        {
            m = 0;
            while (n < 0 || text[p] == ' ')
            {
        ...
        private bool sFlowLinePrefix(int n) // [69] 
        {
        ...
        private bool sSeparate(int n, Context c) // [80] 
        {
            switch (c)
            {
                case Context.BlockOut:
        ...
        private bool sSeparateLines(int n) // [81] 
        {
            return
        ...
        private bool nsReservedDirective() // [83] 
        {
            var name = "";
        ...
        private bool YamlDirectiveAlreadyAppeared;

        private bool nsYamlDirective() // [86] 
        {
            var version = "";
            return RewindUnless(() =>
                Accept("YAML") &&
        ...
        private bool nsTagDirective() // [88] 
        {
            var tag_handle = "";
            var tag_prefix = "";
            return RewindUnless(() =>
        ...
        private bool c_nsProperties(int n, Context c) // [96] 
        {
            state.anchor = null;
            state.tag = null;
            return
        ...
        private bool c_nsTagProperty() // [97]' 
        {
            if (text[p] != '!')
                return false;
        ...
        private bool c_nsAnchorProperty() // [101] 
        {
            if (text[p] != '&')
                return false;
            p++;
        ...
        {
            return RewindUnless(() =>
                sFlowFolded(n) && nsSingleChar() && nb_nsSingleInLine() &&
        ...
        private enum ChompingIndicator
        {
            Strip,
            Keep,
            Clip
        ...
        private bool cIndentationIndicator(ref int m) // [163] 
        {
        ...
        private bool cChompingIndicator(ref ChompingIndicator t) // [164] 
        {
            switch (text[p])
            {
                case '-':
        ...
        private int AutoDetectIndentation(int n) // [170, 183]
        {
        ...
        private bool c_lLiteral(int n) // [170] 
        {
            Debug.Assert(stringValue.Length == 0);
        ...
        private bool l_nbLiteralText(int n) // [171] 
        {
            return RewindUnless(() =>
        ...
        private bool b_nbLiteralNext(int n) // [172] 
        {
            return RewindUnless(() =>
                bAsLineFeed() &&
                !cForbidden() &&
        ...
        private bool s_lBlockIndented(int n, Context c) // [185] 
        {
            int m;
            return
        ...
        private bool s_lBlockNode(int n, Context c) // [196] 
        {
            return
                s_lBlockInBlock(n, c) ||
                s_lFlowInBlock(n);
        ...
        private bool s_lFlowInBlock(int n) // [197] 
        {
            return RewindUnless(() =>
        ...
        private bool s_lBlockInBlock(int n, Context c) // [198] 
        {
            Debug.Assert(stringValue.Length == 0);
            return
                s_lBlockScalar(n, c) ||
        ...
        private bool s_lBlockScalar(int n, Context c) // [199] 
        {
            return RewindUnless(() =>
                sSeparate(n + 1, c) &&
        ...
        private bool s_lBlockCollection(int n, Context c) // [200]
        {
            return RewindUnless(() =>
        ...
        private bool lDocumentSuffix() // [205] 
        {
            return RewindUnless(() =>
                cDocumentEnd() &&
                s_lComments()
        ...
        private bool lBareDocument() // [207] 
        {
        ...
        private bool lExplicitDocument() // [208] 
        {
            return RewindUnless(() =>
                cDirectivesEnd() &&
        ...
        private bool lDirectiveDocument() // [209] 
        {
