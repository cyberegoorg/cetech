...
namespace System.Yaml
{
    ...
    internal class YamlTagPrefixes
    {
        ...
        private readonly Dictionary<string, string> TagPrefixes = new Dictionary<string, string>();
            ...
            if (TagPrefixes.ContainsKey(tag_handle))
            {
                switch (tag_handle)
                {
                    ...
                    case "!!":
                        ...
                        break;
                    default:
                        Error("Tag prefix for the handle {0} is already defined as '{1}'.", tag_handle,
                            TagPrefixes[tag_handle]);
                        break;
                }
            }
