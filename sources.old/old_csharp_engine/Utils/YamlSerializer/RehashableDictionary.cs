...
{
    internal interface IRehashableKey
    {
    ...
    ///         Keys of this dictionary must implement <see cref="IRehashableKey" />.
    ///     </para>
    ///     <para>
    ///         It also call back item addition and removal by <see cref="Added" /> and
    ///         <see cref="Removed" /> events.
    ///     </para>
    /// </summary>
        ...
        where K : class, IRehashableKey
    {
        ...
        /// </remarks>
        private readonly Dictionary<K, int> hashes = new Dictionary<K, int>(
            TypeUtils.EqualityComparerByRef<K>.Default);

        /// <summary>
        ///     <para>
        ///         A dictionary that returns <see cref="KeyValue" /> or <see cref="List&lt;KeyValue&gt;" />
        ///         from hash code. This is the main repository that stores the <see cref="KeyValue" /> pairs.
        ///     </para>
        ///     <para>
        ...
        ///         Otherwise, a <see cref="KeyValue" /> is stored.
        ///     </para>
        /// </summary>
        private SortedDictionary<int, object> items = new SortedDictionary<int, object>();
        ...
        ///     <see cref="object.ReferenceEquals" /> to one exsisting in the dictionary.
        /// </param>
        ...
        private void AddCore(K key, V value, bool exclusive)
        {
        ...
        private void ReplaceKeyValue(KeyValue oldkv, KeyValue newkv, bool exclusive)
        {
            if (exclusive)
        ...
        private bool RemoveCore(K key, bool compareValue, V value)
        {
            var result = true;
        ...
        private void FindItem(K key, bool compareValue, V value,
        ...
        private IEnumerator<KeyValue> GetEnumeratorCore(IDictionary<int, object> items)
        {
        ...
        private class ItemsCollection : KeysValuesBase<KeyValuePair<K, V>>
        {
            private readonly List<KeyValue> list;
        ...
        /// </summary>
        private abstract class KeysValuesBase<T> : ICollection<T>, IDisposable
        {
            protected readonly RehashableDictionary<K, V> Dictionary;
            ...
            private void DictionaryChanged(object sender, DictionaryEventArgs e)
            {
                Invalid = true;
            }
        ...
        private class KeyCollection : KeysValuesBase<K>
        {
        ...
        private class ValueCollection : KeysValuesBase<V>
        {
