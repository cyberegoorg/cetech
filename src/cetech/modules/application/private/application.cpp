...
#define CONFIG_BOOT_PKG CT_ID64_0("core.boot_pkg")
#define CONFIG_DAEMON CT_ID64_0("daemon")
#define CONFIG_COMPILE CT_ID64_0("compile")
#define CONFIG_CONTINUE CT_ID64_0("continue")
#define CONFIG_WAIT CT_ID64_0("wait")
#define CONFIG_GAME CT_ID64_0("game")
