...
#include "cetech/modules/debugui/private/iconfontheaders/icons_kenney.h"
#include "cetech/modules/debugui/private/iconfontheaders/icons_font_awesome.h"
...
void imguiBeginFrame(float _mx, float _my, uint8_t _button, int32_t _scroll, uint16_t _width, uint16_t _height, char _inputChar = 0, uint8_t _view = 255);
void imguiEndFrame();
