...
typedef void(*ct_viewport_on_pass_t)(struct viewport_instance *viewport,
                                     struct ct_viewport viewport_id,
                                     uint8_t viewid,
                                     uint8_t layeridx,
...
struct ct_viewport_a0 {
    ...
    struct ct_render_texture_handle (*get_global_resource)(uint64_t name);

    struct ct_render_texture_handle (*get_local_resource)(struct ct_viewport viewport,
                                            uint64_t name);
