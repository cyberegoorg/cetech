...
struct ct_render_texture_handle renderer_get_global_resource(uint64_t name) {
...
static ct_render_texture_handle get_local_resource(viewport_instance &instance,
                                     uint64_t name) {
...
static struct ct_render_texture_handle
