...
static stbrp__findresult stbrp__skyline_pack_rectangle(stbrp_context *context,
    ...
    stbrp__findresult res = stbrp__skyline_find_best_pos(context, width,
                                                         height);
    stbrp_node *node, *cur;
...
static int rect_height_compare(const void *a,
                               const void *b) {
...
static int rect_width_compare(const void *a,
                              const void *b) {
    stbrp_rect *p = (stbrp_rect *) a;
    stbrp_rect *q = (stbrp_rect *) b;
    if (p->w > q->w)
...
static int rect_original_order(const void *a,
                               const void *b) {
    stbrp_rect *p = (stbrp_rect *) a;
    stbrp_rect *q = (stbrp_rect *) b;
    return (p->was_packed < q->was_packed) ? -1 : (p->was_packed >
                                                   q->was_packed);
}
