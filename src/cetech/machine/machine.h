...
typedef struct ct_machine_ev_queue_o0 ct_machine_ev_queue_o0;
...
typedef struct ct_machine_window_resize_ev_t0 {
    uint64_t window_id;
    uint64_t width;
    uint64_t height;
} ct_machine_window_resize_ev_t0;


typedef struct ct_machine_mouse_ev_t0 {
    ce_vec2_t pos;
    uint64_t btn;
} ct_machine_mouse_ev_t0;

typedef struct ct_machine_keyboard_ev_t0 {
    uint64_t keycode;
    char text[32];
} ct_machine_keyboard_ev_t0;

typedef struct ct_machine_gamepad_ev_t0 {
    uint64_t gamepad_id;
    uint64_t axis_id;
    ce_vec2_t pos;
    uint64_t btn;
} ct_machine_gamepad_ev_t0;

typedef struct ct_machine_ev_t0 {
    uint64_t ev_type;
    union {
        ct_machine_window_resize_ev_t0 window_resize;
        ct_machine_mouse_ev_t0 mouse;
        ct_machine_keyboard_ev_t0 key;
        ct_machine_gamepad_ev_t0 gamepad;
    };
} ct_machine_ev_t0;
