...
static int _mesh_has(lua_State *l) {
    ...
    luasys_push_bool(l, MeshApiV0.has(w, ent));
    return 1;
}
...
static int _mesh_get_material(lua_State *l) {
    ...
    luasys_push_handler(l, MeshApiV0.get_material(w, m).h);
    return 1;
}
...
static int _mesh_set_material(lua_State *l) {
    ...
    MeshApiV0.set_material(w, m, material);
