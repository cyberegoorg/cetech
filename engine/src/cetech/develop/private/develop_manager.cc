...
namespace cetech {
    ...
    namespace develop_manager {
        ...
        void leave_scope(const char* name, time::PerfTimer& start_time) {
            --_scope_depth;
            ScopeEvent event = {
                .name = name,
        ...
        static void begintask_to_json(const void* event, rapidjson::Document& document) {
