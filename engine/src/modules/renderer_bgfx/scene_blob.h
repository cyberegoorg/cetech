...
#define scene_blob_geom_name(r) ((uint64_t*) ((r) + 1))
...
#define scene_blob_node_name(r) ((uint64_t*) (scene_blob_vb(r) + ((r)->vb_len)))
...
#define scene_blob_geom_node(r) ((uint64_t*) (scene_blob_node_pose(r) + ((r)->node_count)))
