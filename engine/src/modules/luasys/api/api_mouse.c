...
static int _mouse_button_index(lua_State *l) {
    ...
    uint32_t idx = ct_mouse_api_v0.button_index(name);
...
static int _mouse_button_name(lua_State *l) {
    ...
    luasys_push_string(l, ct_mouse_api_v0.button_name(idx));
...
static int _mouse_button_state(lua_State *l) {
    ...
    luasys_push_bool(l, ct_mouse_api_v0.button_state(0, idx));
...
static int _mouse_button_pressed(lua_State *l) {
    ...
    luasys_push_bool(l, ct_mouse_api_v0.button_pressed(0, idx));
...
static int _mouse_button_released(lua_State *l) {
    ...
    luasys_push_bool(l, ct_mouse_api_v0.button_released(0, idx));
...
static int _mouse_axis_index(lua_State *l) {
    ...
    uint32_t idx = ct_mouse_api_v0.axis_index(name);
...
static int _mouse_axis_name(lua_State *l) {
    ...
    luasys_push_string(l, ct_mouse_api_v0.axis_name(idx));
...
static int _mouse_axis(lua_State *l) {
    ...
    vec2f_t pos = ct_mouse_api_v0.axis(0, idx);
...
void _register_lua_mouse_api(struct ct_api_v0 *api) {
