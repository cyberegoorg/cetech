...
static int _gamepad_button_index(lua_State *l) {
    ...
    uint32_t idx = ct_gamepad_api_v0.button_index(name);
...
static int _gamepad_button_name(lua_State *l) {
    ...
    luasys_push_string(l, ct_gamepad_api_v0.button_name(idx));
...
static int _gamepad_button_state(lua_State *l) {
    ...
    luasys_push_bool(l, ct_gamepad_api_v0.button_state(gamepad, idx));
...
static int _gamepad_button_pressed(lua_State *l) {
    ...
    luasys_push_bool(l, ct_gamepad_api_v0.button_pressed(gamepad, idx));
...
static int _gamepad_button_released(lua_State *l) {
    ...
    luasys_push_bool(l, ct_gamepad_api_v0.button_released(gamepad, idx));
...
static int _gamepad_axis_index(lua_State *l) {
    ...
    uint32_t idx = ct_gamepad_api_v0.axis_index(name);
...
static int _gamepad_axis_name(lua_State *l) {
    ...
    luasys_push_string(l, ct_gamepad_api_v0.axis_name(idx));
...
static int _gamepad_axis(lua_State *l) {
    ...
    vec2f_t pos = ct_gamepad_api_v0.axis(gamepad, idx);
...
static int _gamepad_is_active(lua_State *l) {
    ...
    luasys_push_bool(l, ct_gamepad_api_v0.is_active(gamepad));
    return 1;
}
...
static int _gamepad_play_rumble(lua_State *l) {
    ...
    ct_gamepad_api_v0.play_rumble(gamepad, strength, length);
    return 0;
}

#define API_NAME "Gamepad"

void _register_lua_gamepad_api(struct ct_api_v0 *api) {
