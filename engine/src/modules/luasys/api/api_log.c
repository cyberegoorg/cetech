...
static int _log_info(lua_State *l) {
    ...
    ct_log_api_v0.info(where, "%s", buffer);
    return 0;
}
...
static int _log_warning(lua_State *l) {
    ...
    ct_log_api_v0.warning(where, "%s", buffer);
    return 0;
}
...
static int _log_error(lua_State *l) {
    ...
    ct_log_api_v0.error(where, "%s", buffer);
    return 0;
}
...
static int _log_debug(lua_State *l) {
    ...
    ct_log_api_v0.debug(where, "%s", buffer);
    return 0;
}

void _register_lua_log_api(struct ct_api_v0 *api) {
