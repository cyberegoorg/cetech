...
namespace cetech {
    ...
    namespace error_globals {
        void init() {
            _scope_name = MAKE_NEW(memory_globals::default_allocator(), Array<const char*>, memory_globals::default_allocator());
            _scope_data = MAKE_NEW(memory_globals::default_allocator(), Array<const char*>, memory_globals::default_allocator());
        }
