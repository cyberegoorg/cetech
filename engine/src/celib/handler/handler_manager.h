    ...
    ***************************************************************************/
    namespace handler {
        ...
        struct HandlerManager {
            ...
            static handler_type make_handler(const handler_type idx,
                                             const handler_type gen) {
                return ((idx) << (index_bit_count)) | (gen);
            }

            static handler_type create(Queue < free_idx_type >& free_idx,
            ...
            static void destroy(handler_type handler,
                                Queue < free_idx_type >& free_idx,
                                Array < gen_type >& generation) {
            ...
            static bool alive(handler_type handler,
                              const Array < gen_type >& generation) {
